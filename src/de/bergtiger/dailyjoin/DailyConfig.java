...
//		File file_day = new File("plugins/DailyJoin/", cfg.getString("config.FileDay"));
//		if(!file_day.exists()){
//			try {
//				FileWriter w = new FileWriter(file_day);
...
//				w.close();
//			} catch (IOException e) {
//				System.out.println("Error Create File: " + cfg.getString("config.FileDay"));
//			}
//		}
		
//		File file_totaldays = new File("plugins/DailyJoin/", cfg.getString("config.FileTotalDays"));
//		if(!file_totaldays.exists()){
//			try{
//				FileWriter w = new FileWriter(file_totaldays);
...
//				w.close();
//			} catch (IOException e){
//				System.out.println("Error Create File: " + cfg.getString("config.FileTotalDays"));
//			}
//		}
